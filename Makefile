...
pkgdatadir = $(datadir)/ONEMcore
pkgincludedir = $(includedir)/ONEMcore
pkglibdir = $(libdir)/ONEMcore
pkglibexecdir = $(libexecdir)/ONEMcore
...
CONFIG_HEADER = $(top_builddir)/src/config/ONEM-config.h
CONFIG_CLEAN_FILES = libONEMconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/ONEM-config.h.in \
...
ACLOCAL = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = ONEMcore
PACKAGE_BUGREPORT = https://github.com/onemancoin/onemancoin/issues
PACKAGE_NAME = ONEM Core
PACKAGE_STRING = ONEM Core 0.12.4
PACKAGE_TARNAME = ONEMcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin
abs_srcdir = /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin
abs_top_builddir = /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin
abs_top_srcdir = /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/angrypool/wallets/onemancoin/20180507_1327/onemancoin/build-aux/install-sh
...
pkgconfig_DATA = libONEMconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/ONEMd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/ONEM-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/ONEM-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = ONEM-Qt.app
OSX_DMG = ONEM-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_ONEM_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_ONEM_coverage.info test_ONEM.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ONEM-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/ONEM-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/ONEM-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/ONEM-config.h
$(top_srcdir)/src/config/ONEM-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/ONEM-config.h src/config/stamp-h1
libONEMconsensus.pc: $(top_builddir)/config.status $(srcdir)/libONEMconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/ONEM-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ONEM-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "ONEM-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ONEM-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_ONEM.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_ONEM -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_ONEM_filtered.info: test_ONEM.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_ONEM_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_ONEM_filtered.info
...
#test_ONEM_coverage.info: baseline_filtered_combined.info test_ONEM_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ONEM_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_ONEM_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ONEM_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_ONEM.coverage/.dirstamp:  test_ONEM_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_ONEM.coverage/.dirstamp total.coverage/.dirstamp

# ONEM: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_ONEM.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
