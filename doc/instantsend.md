...
This mechanism has been integrated into Bitcore-Node-ONEM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ONEMpay/insight-api-ONEM#web-socket-api](https://github.com/ONEMpay/insight-api-ONEM#web-socket-api)
* API: [https://github.com/ONEMpay/insight-api-ONEM#instantsend-transactions](https://github.com/ONEMpay/insight-api-ONEM#instantsend-transactions)
...
By default, the ONEM Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ONEM Core daemon:
