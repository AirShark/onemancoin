...
Then, to tunnel a SSL connection on 29321 to a RPC server bound on localhost on port 18332 do:

    stunnel -d 29321 -r 127.0.0.1:18332 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:9321/
        ProxyPassReverse http://127.0.0.1:9321/
