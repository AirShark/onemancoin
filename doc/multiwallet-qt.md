...
Only requiring some minor changes is ONEM.cpp.
...
Changes to ONEM.cpp
----------------------
ONEM.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
