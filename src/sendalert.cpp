...
2. run ONEMd with -printalert or -sendalert like this:
   /path/to/ONEMd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://onemancoin.cash";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/ONEM Core:0.12.0.58/"));
