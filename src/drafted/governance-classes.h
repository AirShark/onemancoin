 ...
 *
 *   // network
 *   CONEMNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ONEM.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CONEMNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ONEMNetwork
// //   -- signature requirements : Key1(User)
// class CONEMNetworkVariable : public CGovernanceObject
// {
// private:
