...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all ONEM related functionality
...
/*
    ...
    allow endless transaction that would bloat ONEM and make it unusable. To
