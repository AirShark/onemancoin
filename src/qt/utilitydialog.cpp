    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ONEM Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ONEM Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ONEM-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ONEM in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ONEM, 0.1 ONEM, 1 ONEM and 10 ONEM -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ONEM Core is shutting down...") + "<br /><br />" +
