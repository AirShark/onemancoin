    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ONEM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ONEM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ONEM: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ONEM Core"), this);
    aboutAction->setStatusTip(tr("Show information about ONEM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ONEM Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ONEM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ONEM addresses"));
    ...
    openAction->setStatusTip(tr("Open a ONEM: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ONEM Core help message to get a list with possible ONEM Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ONEM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ONEM network", "", count));
    } else {
...
{
    QString strTitle = tr("ONEM Core"); // default title
