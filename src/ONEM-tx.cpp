...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ONEM Core ONEM-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ONEM-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ONEM transaction") + "\n" +
              "  ONEM-tx [options] -create [commands]   " + _("Create hex-encoded ONEM transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ONEM transaction
