/* src/config/ONEM-config.h.  Generated from ONEM-config.h.in by configure.  */
/* src/config/ONEM-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ONEM_CONFIG_H

#define ONEM_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/onemancoin/onemancoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ONEM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ONEM Core 0.12.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ONEMcore"
